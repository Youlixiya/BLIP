...
class BLIPQADataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image_path = self.datas[index]['image']
...
def parse_option():
    ...
    parser.add_argument('--save_iters', type=int, default=1000, help='save iterations')
...
if __name__ == "__main__":
    ...
    model = BlipVisionAeForQuestionAnswering.from_pretrained("./ckpts/blip-vqa-capfilt-large")
    ...
    train_dataset = BLIPQADataset('data/blip/blip_refcoco3_rec_643k.json')
